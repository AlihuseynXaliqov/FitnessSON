...
namespace FitnessApp.DAL.Migrations
{
    ...
    [Migration("20250218121456_AddTagProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Core.Product.TagProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Core.Product.Product", b =>
                {
                    b.HasOne("FitnessApp.Core.Product.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("FitnessApp.Core.Product.TagProduct", b =>
                {
                    ...
                    b.HasOne("FitnessApp.Core.Product.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
