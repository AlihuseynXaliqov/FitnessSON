...
namespace FitnessApp.DAL.Migrations
{
    ...
    [Migration("20250215100919_AddPlan")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Core.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Core.ClientFeedBack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(250)
            ...
            modelBuilder.Entity("FitnessApp.Core.PricingPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Core.TrainerPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Core.BlogPost", b =>
                {
                    b.HasOne("FitnessApp.Core.AppUser", "User")
                        .WithMany("BlogPosts")
            ...
            modelBuilder.Entity("FitnessApp.Core.Trainer", b =>
                {
                    b.HasOne("FitnessApp.Core.TrainerPosition", "Position")
                        .WithMany("Trainers")
